...
@section('page-description', 'Chỉnh sửa thông tin voucher')
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.vouchers.update', $voucher) }}">
                    ...
                    <div class="row">
                        ...
                        <!-- Mã Voucher (Read-only) -->
                        <div class="col-md-6 mb-3">
                            <label for="code" class="form-label">Mã Voucher</label>
                            <input type="text" class="form-control" 
                                   id="code" value="{{ $voucher->code }}" readonly disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('min_order_amount') is-invalid @enderror" 
                                   ...
                                   value="{{ old('min_order_amount', $voucher->min_order_amount) }}" step="1000" min="0">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('max_discount') is-invalid @enderror" 
                                   ...
                                   value="{{ old('max_discount', $voucher->max_discount) }}" step="1000" min="0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('starts_at') is-invalid @enderror" 
                                   ...
                                   value="{{ old('starts_at', $voucher->starts_at ? \Carbon\Carbon::parse($voucher->starts_at)->format('Y-m-d\TH:i') : '') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('expires_at') is-invalid @enderror" 
                                   ...
                                   value="{{ old('expires_at', $voucher->expires_at ? \Carbon\Carbon::parse($voucher->expires_at)->format('Y-m-d\TH:i') : '') }}">
