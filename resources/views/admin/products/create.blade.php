                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                       value="{{ old('name') }}" placeholder="Nhập tên sản phẩm (tối đa 255 ký tự)" required maxlength="255">
                                @error('name')
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror" 
                                          placeholder="Nhập mô tả sản phẩm (tối đa 2500 ký tự)" required maxlength="2500">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="features" rows="3" class="form-control @error('features') is-invalid @enderror" 
                                          placeholder="Nhập các tính năng nổi bật (tối đa 2500 ký tự)" maxlength="2500">{{ old('features') }}</textarea>
                                @error('features')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" name="serial_number" class="form-control @error('serial_number') is-invalid @enderror" 
                                       value="{{ old('serial_number') }}" placeholder="VD: SN001, SN002..." maxlength="255">
                                @error('serial_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" name="model" class="form-control @error('model') is-invalid @enderror" 
                                       value="{{ old('model') }}" placeholder="VD: ZKTeco F18, MB560, ..." maxlength="255">
                                @error('model')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="invalid-feedback">Tối đa 255 ký tự</div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea id="specs" name="specs" rows="6" class="form-control @error('specs') is-invalid @enderror" 
                                          placeholder='Nhập JSON (ví dụ: {"CPU":"280MHz DSP"}) hoặc từng dòng "Key: Value"' maxlength="2500">{{ old('specs') }}</textarea>
                                @error('specs')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="invalid-feedback">Tối đa 2500 ký tự</div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="min_rental_months" class="form-control @error('min_rental_months') is-invalid @enderror" 
                                       value="{{ old('min_rental_months', 6) }}" min="1" max="60" placeholder="Nhập số tháng (1-60)" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="stock_quantity" class="form-control @error('stock_quantity') is-invalid @enderror" 
                                       value="{{ old('stock_quantity') }}" min="0" max="99999999" placeholder="Nhập số lượng" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_1_month" class="form-control @error('price_1_month') is-invalid @enderror" 
                                       value="{{ old('price_1_month') }}" min="0" max="99999999.99" step="1000" placeholder="Nhập giá">
                                @error('price_1_month')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_6_months" class="form-control @error('price_6_months') is-invalid @enderror" 
                                       value="{{ old('price_6_months') }}" min="0" max="99999999.99" step="1000" placeholder="Nhập giá">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_12_months" class="form-control @error('price_12_months') is-invalid @enderror" 
                                       value="{{ old('price_12_months') }}" min="0" max="99999999.99" step="1000" placeholder="Nhập giá">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_18_months" class="form-control @error('price_18_months') is-invalid @enderror" 
                                       value="{{ old('price_18_months') }}" min="0" max="99999999.99" step="1000" placeholder="Nhập giá">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_24_months" class="form-control @error('price_24_months') is-invalid @enderror" 
                                       value="{{ old('price_24_months') }}" min="0" max="99999999.99" step="1000" placeholder="Nhập giá">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="promotion_badge" class="form-control @error('promotion_badge') is-invalid @enderror" 
                                       value="{{ old('promotion_badge') }}" placeholder="VD: Ưu đãi -10%, Sản phẩm nổi bật" maxlength="100">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="warranty_info" class="form-control @error('warranty_info') is-invalid @enderror" 
                                       value="{{ old('warranty_info') }}" placeholder="VD: Bảo hành 12 tháng" maxlength="2500">
                                @error('warranty_info')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="invalid-feedback">Tối đa 2500 ký tự</div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="promotion_description" rows="3" class="form-control @error('promotion_description') is-invalid @enderror" 
                                          placeholder="Nhập mô tả chi tiết về khuyến mãi" maxlength="2500">{{ old('promotion_description') }}</textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="rental_terms" rows="3" class="form-control @error('rental_terms') is-invalid @enderror" 
                                          placeholder="Nhập các điều khoản thuê" maxlength="2500">{{ old('rental_terms') }}</textarea>
                                @error('rental_terms')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="invalid-feedback">Tối đa 2500 ký tự</div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="delivery_info" rows="3" class="form-control @error('delivery_info') is-invalid @enderror" 
                                          placeholder="Nhập thông tin về giao hàng" maxlength="255">{{ old('delivery_info') }}</textarea>
                                @error('delivery_info')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="invalid-feedback">Tối đa 255 ký tự</div>
