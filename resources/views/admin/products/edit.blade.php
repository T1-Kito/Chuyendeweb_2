                    ...
                    <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="features" rows="3" class="form-control @error('features') is-invalid @enderror">{{ old('features', $product->features) }}</textarea>
                                @error('features')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" name="serial_number" class="form-control @error('serial_number') is-invalid @enderror" 
                                       value="{{ old('serial_number', $product->serial_number) }}" placeholder="VD: SN001, SN002...">
                                @error('serial_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" name="model" class="form-control @error('model') is-invalid @enderror" 
                                       value="{{ old('model', $product->model) }}" placeholder="VD: ZKTeco F18, MB560, ...">
                                @error('model')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea id="specs" name="specs" rows="6" class="form-control @error('specs') is-invalid @enderror" placeholder='Nhập JSON (ví dụ: {"CPU":"280MHz DSP"}) hoặc từng dòng "Key: Value"'>{{ old('specs', $product->specs) }}</textarea>
                                @error('specs')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="min_rental_months" class="form-control @error('min_rental_months') is-invalid @enderror" 
                                       value="{{ old('min_rental_months', $product->min_rental_months) }}" min="1" max="60" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_1_month" class="form-control @error('price_1_month') is-invalid @enderror" 
                                       value="{{ old('price_1_month', $product->price_1_month) }}" min="0" step="1000">
                                @error('price_1_month')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_6_months" class="form-control @error('price_6_months') is-invalid @enderror" 
                                       value="{{ old('price_6_months', $product->price_6_months) }}" min="0" step="1000">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_12_months" class="form-control @error('price_12_months') is-invalid @enderror" 
                                       value="{{ old('price_12_months', $product->price_12_months) }}" min="0" step="1000">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_18_months" class="form-control @error('price_18_months') is-invalid @enderror" 
                                       value="{{ old('price_18_months', $product->price_18_months) }}" min="0" step="1000">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="price_24_months" class="form-control @error('price_24_months') is-invalid @enderror" 
                                       value="{{ old('price_24_months', $product->price_24_months) }}" min="0" step="1000">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="promotion_badge" class="form-control @error('promotion_badge') is-invalid @enderror" 
                                       value="{{ old('promotion_badge', $product->promotion_badge) }}" placeholder="VD: Ưu đãi -10%, Sản phẩm nổi bật">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="warranty_info" class="form-control @error('warranty_info') is-invalid @enderror" 
                                       value="{{ old('warranty_info', $product->warranty_info) }}" placeholder="VD: Bảo hành 12 tháng">
                                @error('warranty_info')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="promotion_description" rows="3" class="form-control @error('promotion_description') is-invalid @enderror">{{ old('promotion_description', $product->promotion_description) }}</textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="rental_terms" rows="3" class="form-control @error('rental_terms') is-invalid @enderror">{{ old('rental_terms', $product->rental_terms) }}</textarea>
                                @error('rental_terms')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="delivery_info" rows="3" class="form-control @error('delivery_info') is-invalid @enderror">{{ old('delivery_info', $product->delivery_info) }}</textarea>
                                @error('delivery_info')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
