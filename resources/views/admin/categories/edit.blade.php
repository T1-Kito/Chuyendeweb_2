...
@section('page-description', 'Cập nhật thông tin danh mục sản phẩm')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-edit me-2"></i>Chỉnh Sửa Danh Mục</h2>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.categories.update', $category) }}" id="categoryForm" novalidate>
            ...
            <input type="hidden" name="original_updated_at" value="{{ $category->updated_at->format('Y-m-d H:i:s') }}">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                                  maxlength="2500"
                                  placeholder="Mô tả chi tiết về danh mục này (tối đa 2500 ký tự)">{{ old('description', $category->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror"
                                   value="{{ old('icon', $category->icon) }}" maxlength="50"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" name="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                               value="{{ old('color', $category->color ?? '#2563eb') }}" title="Chọn màu cho icon">
                        @error('color')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror"
                               value="{{ old('sort_order', $category->sort_order ?? 0) }}" min="0" max="99999999" placeholder="0">
            ...
            <div class="mb-3">
                ...
                <div class="border rounded p-3 bg-light">
                    <div id="iconPreview" class="text-center">
                        @php
                            $iconClass = old('icon', $category->icon ?: 'fas fa-tag');
